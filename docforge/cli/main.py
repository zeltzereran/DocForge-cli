...
from docforge.cli.commands.generate import generate_app
from docforge.cli.commands.rulebook import rulebook_app
...
def init(
    ...
    try:
        ...
        config_content = f"""# DocForge Configuration
# Generated by: docforge init
...
"""
        config_file = repo_path / "docforge.yaml"
...
@app.command()
def doctor() -> None:
    """Check DocForge system health and configuration."""
    from rich.table import Table
    from docforge.adapters import AnthropicAdapter, BlinkerEventBusAdapter, LocalStorageAdapter
    from docforge.core.managers import CompositeConfigAdapter
    
    table = Table(title="DocForge System Health Check")
